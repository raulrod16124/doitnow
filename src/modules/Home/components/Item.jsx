                        ...
                        : <>
                            ...
                            <div className="content-todo">
                                <div className="content-data-todo-left editing">
                                    <input className="todo-title editing" type="text" value={todoData.title} onChange={(e)=>setTodoData({...todoData, title: e.target.value})} />
                                    <select className="todo-level editing" defaultValue={todoData.level} onClick={(e)=>setTodoData({...todoData, level: e.target.value})} >
                                    ...
                                    <div className="content-icons">
                                        <CheckSaveIcon className="icon" size="3" onClick={()=>handleUpdatedTodo(todoData)} />
                                        <CancelIcon className="icon" size="3" onClick={()=>seteditingItem(false)} />
                                    </div>
                                </div>
                                <div className="content-data-todo-rigth editing">
                                    <textarea className="todo-description editing" value={todoData.description} onChange={(e)=>setTodoData({...todoData, description: e.target.value})} ></textarea>
                                </div>
                            </div>
                        </>
